  ...
  <script src="<?php echo base_url(); ?>assets/assets/js/select2.full.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/assets/js/jscolor.js"></script>
  <script src="<?php echo base_url(); ?>assets/assets/js/jquery.inputmask.js"></script>
  <script src="<?php echo base_url(); ?>assets/assets/js/jquery.inputmask.date.extensions.js"></script>
  <script src="<?php echo base_url(); ?>assets/assets/js/jquery.inputmask.extensions.js"></script>
  ...
  <script src="<?php echo base_url(); ?>assets/assets/js/icheck.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/assets/js/fastclick.js"></script>
  <script src="<?php echo base_url(); ?>assets/assets/js/jquery.sparkline.min.js"></script>
